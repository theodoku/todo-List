...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addTodoItem_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addTodoItem.js */ \"./src/modules/addTodoItem.js\");\n/* harmony import */ var _modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/storeTodoTasks.js */ \"./src/modules/storeTodoTasks.js\");\n/* eslint import/no-unresolved:0 */\n\n\n\n\nconst display = () => {\n  const todos = _modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.getTodoTask || [];\n  if (todos) {\n    todos.map((todo) => (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.addTodoTask)(todo));\n  }\n};\n\ndisplay();\n\ndocument.getElementById('form').addEventListener('submit', (e) => {\n  e.preventDefault();\n  const todos = (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.getTodoTask)();\n  const todoInput = document.getElementById('task').value;\n  const todoTask = {\n    index: todos.length,\n    desciption: todoInput,\n    completed: false,\n  };\n\n  if (todoInput !== '') {\n    (0,_modules_addTodoItem_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(todoTask);\n    (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.addTodoTask)(todoTask);\n    document.getElementById('form').reset();\n  }\n});\n\nconst inputField = document.querySelectorAll('.description');\n\ninputField.forEach((todo, index) => {\n  todo.addEventListener('change', (e) => {\n    const updateInput = e.target.value;\n    const todos = (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.getTodoTask)();\n    todos[index].desciption = updateInput;\n    (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.updateTodoTask)(index, todos[index].description);\n    window.location.reload();\n  });\n});\ninputField.forEach((todo, index) => {\n  todo.addEventListener('keypress', (e) => {\n    if (e.key === 'Enter') {\n      const updateInput = e.target.value;\n      const todos = (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.getTodoTask)();\n      todos[index].desciption = updateInput;\n      (0,_modules_storeTodoTasks_js__WEBPACK_IMPORTED_MODULE_2__.updateTodoTask)(index, todos[index].description);\n      window.location.reload();\n    }\n  });\n});\n\n\n//# sourceURL=webpack://webpack-setup/./src/index.js?");
